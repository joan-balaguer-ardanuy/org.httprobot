...
public abstract class AbstractPlaceholder extends XML {
	...
	/**
	 * {@link AbstractPlaceholder} default class constructor.
	 */
	...
	public void OnMessageUnmarshalled(MessageEventArgs e) {
		...
		// set the Contains string operator
		setContains(placeholder.getContains());
		// set the Equals string operator
		setEquals(placeholder.getEquals());
		// set the Trim string operator
		setTrim(placeholder.getTrim());
		// set the Replace string operator
		setReplace(placeholder.getReplace());
		// set the Concat string operator
		setConcat(placeholder.getConcat());
		// set the Substring string operator
		setSubstring(placeholder.getSubstring());
		// set the TryParse string operator
